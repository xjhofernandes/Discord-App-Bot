...
namespace Discord_App_Bot
{
    public class Program : ModuleBase<SocketCommandContext>
    {
        ...
        {
            var botToken = "NjkzMzEwMTYzNTExMTQ4NTY0.Xn8Vpw.Uls0F7i7BE4rO8kEZoZ6SFTfPZY";
            //var botToken = "NjkzMzEwMTYzNTExMTQ4NTY0.Xn7PKw.l1jNDESG8X4n767qNvuwRNIo-Gg";
        ...
        private async Task iniciandoComandos(SocketMessage arg)
        {
            ...
            {
                var result = await _commands.ExecuteAsync(Context, argPost, null);
